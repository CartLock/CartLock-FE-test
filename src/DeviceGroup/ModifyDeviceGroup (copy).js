...
const ModifyDeviceGroup = (props) => {
  ...
  const handleSubmitClick = (e) => {
    ...
    dispatch(modifyDeviceGroup(Data))
  };
                        ...
                        <Box display="flex" alignItems="center">
                          <FormControl variant="outlined">
                            <Autocomplete
                              ...
                              onChange={(event, val) => handleChangeSchedule(val, 'start_at')}
                              options={timeList}
                              getOptionLabel={(option) => option}
                              renderInput={(params) => <TextField {...params} label="Start at" variant="outlined" />}
                            />
                          </FormControl>
                          <FormControl variant="outlined">
                            <Autocomplete
                              size="small"
                              style={{ width: 130, marginLeft: 7 }}
                              id="combo-box-demo"
                              value={device_GroupDetails.end_at}
                              onChange={(event, val) => handleChangeSchedule(val, 'end_at')}
                              options={timeList}
                              getOptionLabel={(option) => option}
                              renderInput={(params) => <TextField {...params} label="End at" variant="outlined" />}
                            />
                          </FormControl>
                          <FormControl variant="outlined">
                            <Autocomplete
