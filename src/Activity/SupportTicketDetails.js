              ...
              <div className='card-header border-0'>
                <div className='row align-items-center'>
                  ...
                  <div className='col-lg-1'>
                    <Link class='btn btn-primary float-right' to='/support'>Supports</Link>
                  </div>
                </div>
              </div>
                    ...
                    <div className="row">
                      <div className="col">
                        ...
                        <Box display="flex" alignItems="center" className="mt-1">
                          ...
                          <Typography variant="subtitle2" component="p" className="ml-2">{supportTicketDetail.User.phone_number}</Typography>
                        </Box>

                        <Box display="flex" alignItems="center" className="mt-1">
                          <Typography variant="subtitle2" className={classes.labelBox}><strong>E-Mail:</strong></Typography>
                          <Typography variant="subtitle2" component="p" className="ml-2">{supportTicketDetail.User.e_mail}</Typography>
                        </Box>
